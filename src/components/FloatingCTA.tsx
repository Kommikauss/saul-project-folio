    ...
    <AnimatePresence>
      {visible && !dismissed && (
        <motion.div
          ...
          className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 bg-dark/95 backdrop-blur-md border border-primary-foreground/10 rounded-2xl px-6 py-3 flex items-center gap-4 shadow-2xl"
        >
